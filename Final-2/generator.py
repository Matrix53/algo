...
io.input_writeln(seq.get(1, 199999))
seq = Sequence(lambda i, f: randint(234561, 2000049999)).get(1, 199998)
seq.sort()
io.input_writeln(seq)
seq = Sequence(lambda i, f: randint(700000229, 903500000)).get(1, 199998)
seq.sort()
io.input_writeln(seq)
...
io.input_writeln(seq.get(1, 199999))
seq = Sequence(lambda i, f: randint(234561, 1300099999)).get(1, 199998)
seq.sort()
io.input_writeln(seq)
seq = Sequence(lambda i, f: randint(603500000, 803500000)).get(1, 199998)
seq.sort()
io.input_writeln(seq)
io.output_gen(code_path + 'standard.exe')
io.close()
